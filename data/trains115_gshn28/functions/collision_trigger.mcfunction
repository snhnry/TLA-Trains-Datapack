...
execute if entity @s[tag=rptrain_angle] positioned ^ ^ ^10 unless entity @e[type=armor_stand,tag=rptrain_train,distance=..4] run function trains115_gshn28:collision
execute if entity @s[tag=rptrain_angle] positioned ^ ^ ^5 unless entity @e[type=armor_stand,name=rptrain_model,distance=..4] run function trains115_gshn28:collision
